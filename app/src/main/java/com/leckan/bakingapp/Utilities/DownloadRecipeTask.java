...
public class DownloadRecipeTask extends AsyncTask<Object, Object, Void> {
    ...
    public DownloadRecipeTask(Context context, RecyclerView moviesRecyclerView, int scrollPosition) {
        mContext = context;
    ...
    protected Void doInBackground(Object... voids) {
        ...
        String jsonStr = NetworkUtils.makeServiceCall(recipeURL.toString());
        if (jsonStr != null) {
            try {
               ...
               // JSONArray myRecipes = jsonObj.getJSONArray("results");
                dRecipes = new ArrayList<Recipe>();
